...
(1, 'João Silva', TO_DATE('2000-01-10', 'YYYY-MM-DD'), 'Rua A, 123', 'joao.silva@example.com', '(11) 1234-5678'),
(2, 'Maria Souza', TO_DATE('1998-05-15', 'YYYY-MM-DD'), 'Av. B, 456', 'maria.souza@example.com', '(22) 9876-5432'),
(3, 'Pedro Santos', TO_DATE('1999-09-20', 'YYYY-MM-DD'), 'Rua C, 789', 'pedro.santos@example.com', '(33) 4567-8901');
